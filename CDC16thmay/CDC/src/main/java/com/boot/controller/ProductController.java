...
public class ProductController {
	...
	private java.util.List<Product> getProducts(@RequestParam("category") String category,
	...
	private java.util.List<Product> findAllByPartialSearch(
			@RequestParam("partialSearchText") String partialSearchText) {
	...
	private void updateProducts(@RequestParam("productId") String productId,@RequestParam("productQnty") String productQnty,
			@RequestParam("productDesc") String productDesc,
			@RequestParam("productPrice") String productPrice,
			@RequestParam("productSubCat") String productSubCat
			) {
		System.out.println("update : ");
		productService.updateProduct(productId,productDesc,productSubCat,productQnty,productPrice);
	}
	
	@RequestMapping(value = "/removeProduct", method = RequestMethod.POST)
	private void removeProducts(@RequestParam("productId") String productId) {
		System.out.println("update : ");

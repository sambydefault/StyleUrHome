...
public class ConsumerController {
	...
	public List<User> login(@RequestParam(value = "userEmail", required = false) String userEmail,
			@RequestParam(value = "userPassword", required = false) String userPassword) {
		// consumerRepository.findByConsumcterEmail(consumerEmail);
		System.out.println("userEmail" + userEmail);
		User user = userService.userExists(userEmail, userPassword, userRepository);
	...
	public ArrayList<ConsumerPrice> submitUserQuote(@RequestParam("userName") String userName,
			...
			@RequestParam("dateRequired") String dateRequired, ConsumerPrice consumerPrice) throws ParseException {
		return consumerService.saveConsumerPrice(userName, userEmail, productID, userPrice, quantity, dateRequired,
				consumerPrice, consumerPriceRepository, productRepository, userRepository);
	}
	...
	public ConsumerPrice approveUserPrice(@RequestParam("consumerPriceId") long consumerPriceId,
			@RequestParam("vendorInfo") String vendorInfo, Vendor vendor, List<ConsumerPrice> listConsumerPrice) {
		return vendorService.approveUserPrice(consumerPriceId, vendorInfo, listConsumerPrice, consumerPriceRepository, vendorRepository);
	}
	...
	public ConsumerPrice dispatchOrder(@RequestParam("userEmail") String userEmail,
			@RequestParam("consumerPriceID") long consumerPriceID, List<ConsumerPrice> listConsumerPrice) {
		return vendorService.dispatchOrder(userEmail, consumerPriceID, listConsumerPrice, consumerPriceRepository,
